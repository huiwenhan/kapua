...
public class EsTransportClientProvider implements EsClientProvider {
    ...
    static Client getClient(List<InetSocketAddress> addresses, String clustername) throws ClientUnavailableException, UnknownHostException {
    ...
    static Client createClient(final AbstractBaseKapuaSetting<ClientSettingsKey> settings) throws ClientUnavailableException {
        try {
